    ...
    subjects: {
        ...
        modern_literature_prose: {
            ...
            notes: [
                ...
                'تعليمات خاصة بدكتور سيد علي: <ul><li>لا يسمح بالتأخير لأكثر من 10 دقائق.</li><li>أهمية حضور كل المحاضرات قبل شهر رمضان.</li><li>عدم ذكر اسم أي دكتور آخر.</li><li>عند طباعة الكتاب المقرر، يجب الإحتفظ باسم الدكتور وذلك لحقوق الملكية.</li></ul>'
            ],
            events: [
                {
                    ...
                    content: [
                        'المحاضرة القادمة عليها أعمال السنة وستشرحها د. هند. (لذا يجب على الجيمع الحضور)'
                    ]
                },
                {
                    ...
                    content: [
                        ...
                        'مطلوب عمل مقال، سيتم الإختيار من ضمن 10 مواضيع، نختار منهم 2... وسيأتي في الإمتحان سؤال إجباري عن المقال يحتوي على موضوعين نختار منهم واحداً.'
                    ]
                }
            ],
            last_update: {
        ...
        popular_literature: {
            ...
            notes: [
                "بيت شعري قاله صديق دكتور صلاح يُعد بمثابة حكمة في الحياة: والعش دا لو يوم ينهجر *** يبدأ نزوله من الشجر... قشاية قشاية."
            ],
            events: [
                {
                    title: "المحاضرة الثانية :check:",
        ...
        criticism: {
            ...
            events: [
                {
                    title: "المحاضرة الثانية :cross:",
                    full_date: "الخميس 16/02/2023 12:00 م"
                },
                {
                    title: "المحاضرة الأولى :cross:",
