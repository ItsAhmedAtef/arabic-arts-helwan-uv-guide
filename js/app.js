            ...
            events: [
                {
                    ...
                    content: [
                        "<h4>اسم فاعل من فعل ثلاثي</h4><p>* قال ← قاول ← قائل (وقعت الواو عيناً لاسم الفاعل فقُلبت الواو همزة).</p><p>* صام ← صائم.</p><p>* قام ← قائم.</p><p>* غار ← غائر.</p><br><p>* عجوز ← عجاوز ← عجائز.</p><br><p>* قال ← (الأصل) ← قول.</p><p>* محا ← (الأصل) ← محو.</p><br><h4>جمع فاعلة على فواعل</h4><p>* واصلة ← وواصل ← أواصل (اجتمعت واوان الثانية منهما متحركة، فتقلب الأولى همزة).</p><p>* وُوْلَى ← أُوْلَى.</p><br><p>* عائدة ← عواود ← عوائد.</p><p>* شائبة ← شوائب.</p><p>* سيد ← سييد ← سيايد ← سيائد.</p><br><p>* قام ← (المصدر) ← قِوام ← قيام (تأثراً بالكسرة).</p><br><p>* حوض ← (أصله) ← حِواض ← حياض (تأثرت الواو بالكثرة).</p><p>* وَزَن ← مِوْازن ← ميزان.</p>",
